                        ...
                        <div className="mb-6">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex items-center gap-2 mb-2">
                                    <code className="flex-grow bg-gray-100 px-3 py-2 rounded">
                                        {`${getRpcEndpoint()}/ext/info`}
                                    </code>
                                    <a
                                        href={`${getRpcEndpoint()}/ext/info`}
                                        target="_blank"
                            ...
                            <p className="mb-4">
                                You should see the message: <code className="bg-gray-100 px-2 py-1 rounded">rpc: POST method required, received GET</code>
                            </p>

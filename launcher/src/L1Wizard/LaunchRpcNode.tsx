...
const dockerCommand = (subnetID: string) => `mkdir -p ~/.avalanchego_rpc/staking; docker run -it -d \\
...
export default function LaunchRpcNode() {
    ...
    return (
        <>
            ...
            <pre className="bg-gray-100 p-4 rounded-md mb-4">{dockerCommand(subnetId)}</pre>
